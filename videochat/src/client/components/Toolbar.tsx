...
import { getTranslation, langCode } from './translations/Translations'
    ...
    return (
      <div className="toolbar active">
        ...
        <ToolbarButton
          ...
          title={getTranslation("Toggle Chat", langCode)}
        />
        ...
        <ToolbarButton
          ...
          title={getTranslation("Send File", langCode)}
        />
        ...
        <ToolbarButton
          ...
          title={getTranslation("Share Desktop", langCode)}
        />
        ...
        {stream && (
          <React.Fragment>
            <ToolbarButton
              ...
              icon='icon-mic_off'
              offIcon='icon-mic'
              title={getTranslation("Toggle Microphone", langCode)}
            />
            <ToolbarButton
              ...
              title={getTranslation("Toggle Camera", langCode)}
            />
          </React.Fragment>
        )}
        ...
        <ToolbarButton
          ...
          title={getTranslation("Toggle Fullscreen", langCode)}
        />
          ...
          {this.props.stream && this.props.stream.stream && (
            <ToolbarButton
              ...
              className='hangup'
              icon='icon-call_end'
              title={getTranslation("Hang Up", langCode)}
            />
          )}
